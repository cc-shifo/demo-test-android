...
public class KeyboardView extends View implements View.OnClickListener {
    ...
    public KeyboardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        a = mContext.obtainStyledAttributes(new int[] {android.R.attr.backgroundDimAmount});
        //a = mContext.obtainStyledAttributes(android.R.styleable.Theme);/*R.styleable.Theme*/
        //mBackgroundDimAmount = a.getFloat(com.android.internal.R.Theme_backgroundDimAmount, 0.5f);
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (mKeyboard == null) {
            ...
            setMeasuredDimension(getPaddingStart() + getPaddingEnd(),
                    getPaddingTop() + getPaddingBottom());
        } else {
//            int width = mKeyboard.getMinWidth() + mPaddingLeft + mPaddingRight;
            int width = mKeyboard.getMinWidth() + getPaddingStart() + getPaddingEnd();
...
//        final int kbdPaddingTop = mPaddingTop;
        final int kbdPaddingLeft = getPaddingStart();
...
//            mPopupPreviewX = key.x - mPreviewText.getPaddingLeft() + mPaddingLeft;
            mPopupPreviewX = key.x - mPreviewText.getPaddingLeft() + getPaddingStart();
...
//                key.x + key.width + mPaddingLeft, key.y + key.height + mPaddingTop);
        mDirtyRect.union(key.x + getPaddingStart(), key.y + getPaddingTop(),
                key.x + key.width + getPaddingStart(), key.y + key.height + getPaddingTop());
        onBufferDraw();
//        invalidate(key.x + mPaddingLeft, key.y + mPaddingTop,
//                key.x + key.width + mPaddingLeft, key.y + key.height + mPaddingTop);
        invalidate(key.x + getPaddingStart(), key.y + getPaddingTop(),
                key.x + key.width + getPaddingStart(), key.y + key.height + getPaddingTop());
    }
...
//        int touchY = (int) me.getY() - mPaddingTop;
        int touchX = (int) me.getX() - getPaddingStart();
