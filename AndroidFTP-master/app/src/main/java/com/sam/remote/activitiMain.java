...
public class activitiMain extends Activity {
	  ...
	  private final String sDir = "/public_html";
	  private String[] array_spinner;
	  ScrollView sv;
	 
	 
		private final LinearLayout.LayoutParams LP_FF = new LinearLayout.LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT);
    ...
    private class processTask extends AsyncTask<String, Void, Void>{
    	private final ProgressDialog Dialog = new ProgressDialog(activitiMain.this);
		...
		protected Void doInBackground(String... arg0) {
	        ...
	        SharedPreferences myPref = PreferenceManager.getDefaultSharedPreferences(getBaseContext());
	   		...
	   		String pass= myPref.getString("pass", "");
	            ...
	            boolean login = client.login("Anonymous", pass);
