...
public class RoutePOIActivity extends Activity implements OnMapClickListener,
    ...
    private final int mode = RouteSearch.DrivingDefault;
    ...
    private void searchRoutePOI(RoutePOISearchType type) {
        ...
        RoutePOISearchQuery query = new RoutePOISearchQuery(mStartPoint, mEndPoint, mode, type,
                250);
    ...
    private class myRoutePoiOverlay {
        ...
        private final List<RoutePOIItem> mPois;
