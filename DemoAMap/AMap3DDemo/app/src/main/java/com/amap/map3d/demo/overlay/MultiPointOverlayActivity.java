...
public class MultiPointOverlayActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        marker =
                aMap.addMarker(new MarkerOptions().icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_RED)));

        BitmapDescriptor bitmapDescriptor =
                BitmapDescriptorFactory.fromResource(R.drawable.marker_blue);
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    inputStream =
                            MultiPointOverlayActivity.this.getResources().openRawResource(R.raw.point10w);
