...
public class PoiAroundSearchActivity extends Activity implements OnClickListener,
    ...
    private final LatLonPoint lp = new LatLonPoint(39.993743, 116.472995);// 116.472995,39.993743
    ...
    protected void doSearchQuery() {
        ...
        currentPage = 0;
        query = new PoiSearch.Query(keyWord, "", "");// 第一个参数表示搜索字符串，第二个参数表示poi搜索类型，第三个参数表示poi
        // 搜索区域（空字符串代表全国）
