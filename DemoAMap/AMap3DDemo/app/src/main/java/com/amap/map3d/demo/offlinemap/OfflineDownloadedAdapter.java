...
public class OfflineDownloadedAdapter extends BaseAdapter {
    ...
    private final List<OfflineMapCity> cities = new ArrayList<OfflineMapCity>();
    ...
    private void initCityList() {
        if (cities != null) {
            ...
            Log.d("amap",
                    "Offline Downloading notifyData cities iterator cost: " + (System.currentTimeMillis() - start));
            // arraylist中的元素不能这样移除
        ...
        Log.d("amap",
                "Offline Downloading notifyData getDownloadingCityList cost: " + (System.currentTimeMillis() - start));

        start = System.currentTimeMillis();
        notifyDataSetChanged();
        Log.d("amap",
                "Offline Downloading notifyData notifyDataSetChanged cost: " + (System.currentTimeMillis() - start));
