        ...
        synchronized (ParticleMapActivity.class) {
            ...
            switch (id) {
                ...
                case R.id.custom:
                    ...
                    //            particleOverLifeModule.setVelocityOverLife(new com.amap.api
                    //            .maps.model.particle.RandomVelocityBetweenTwoConstants(1, 1,0,
                    //            5,5,0));
                    ...
                    ParticleOverlay particleOverlay =
                            aMap.addParticleOverlay(particleSystemOptions);
                    particleOverlayList.add(particleOverlay);
