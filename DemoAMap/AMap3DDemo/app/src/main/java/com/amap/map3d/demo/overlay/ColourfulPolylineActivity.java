...
public class ColourfulPolylineActivity extends Activity {
    ...
    private final double Lat_A = 39.981167;
    private final double Lon_A = 116.345103;

    private final double Lat_B = 39.981265;
    private final double Lon_B = 116.347152;

    private final double Lat_C = 39.979387;
    private final double Lon_C = 116.347356;

    private final double Lat_D = 39.979313;
    private final double Lon_D = 116.348896;
