...
public class DriveRoutePlanActivity extends Activity implements OnMapClickListener,
        ...
        RouteSearch.OnRoutePlanSearchListener, View.OnClickListener {
    private AMap aMap;
    ...
    private final LatLonPoint mStartPoint = new LatLonPoint(39.942295, 116.335891);//起点，39
    // .942295,116.335891
    private final LatLonPoint mEndPoint = new LatLonPoint(39.995576, 116.481288);//终点，39.995576,
    // 116.481288
    ...
    public void searchRouteResult(int routeType, int mode) {
        ...
        if (routeType == ROUTE_TYPE_DRIVE) {// 驾车路径规划
            ...
            DrivePlanQuery query = new DrivePlanQuery(fromAndTo, time + utils.queryFirstInterval,
                    utils.queryInterval * 60, 48);//
                ...
                travelView.init(result, new TravelView.IndexListener() {
                    ...
                    public void onClicked(int index) {
                        ...
                        if (result.getPaths().size() > 0) {
                            ...
                            DrivingRoutePlanOverlay drivingRouteOverlay =
                                    new DrivingRoutePlanOverlay(
