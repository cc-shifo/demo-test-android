...
public class RouteActivity extends Activity implements OnMapClickListener,
    ...
    private final LatLonPoint mStartPoint = new LatLonPoint(39.942295, 116.335891);//起点，116
    // .335891,39.942295
    private final LatLonPoint mEndPoint = new LatLonPoint(39.995576, 116.481288);//终点，116.481288,
    // 39.995576
    private final LatLonPoint mStartPoint_bus = new LatLonPoint(40.818311, 111.670801);//起点，111
    // .670801,40.818311
    private final LatLonPoint mEndPoint_bus = new LatLonPoint(44.433942, 125.184449);//终点，
    private final String mCurrentCityName = "北京";
        ...
        if (errorCode == AMapException.CODE_AMAP_SUCCESS) {
            if (result != null && result.getPaths() != null) {
                if (result.getPaths().size() > 0) {
                    ...
                    String des =
                            AMapUtil.getFriendlyTime(dur) + "(" + AMapUtil.getFriendlyLength(dis) + ")";
