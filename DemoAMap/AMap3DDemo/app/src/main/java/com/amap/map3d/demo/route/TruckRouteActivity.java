...
public class TruckRouteActivity extends Activity implements RouteSearch.OnTruckRouteSearchListener {
    ...
    private final LatLonPoint mStartPoint = new LatLonPoint(39.902896, 116.42792);
    private final LatLonPoint mEndPoint = new LatLonPoint(39.894914, 116.322062);//终点，39.995576,
    // 116.481288
    ...
    public void searchRouteResult(int mode) {
        ...
        RouteSearch.TruckRouteQuery query = new RouteSearch.TruckRouteQuery(fromAndTo, mode, null
