...
public class PolylineActivitybase extends Activity implements
     ...
     */
    private final double Lat_A = 35.909736;
    private final double Lon_A = 80.947266;

    private final double Lat_B = 35.909736;
    private final double Lon_B = 89.947266;

    private final double Lat_C = 31.909736;
    private final double Lon_C = 89.947266;

    private final double Lat_D = 31.909736;
    private final double Lon_D = 99.947266;
    ...
    private void addShownMarker() {
        aMap.addMarker(new MarkerOptions().position(new LatLng(116.3478962642899,
                39.98098214824056)).title("tip").snippet("步行轨迹展示")).showInfoWindow();
        aMap.setOnMapClickListener(new OnMapClickListener() {

            @Override
            public void onMapClick(LatLng arg0) {
                // TODO Auto-generated method stub
                aMap.moveCamera(CameraUpdateFactory.newLatLngZoom(new LatLng(116.3478962642899,
                        39.98098214824056), 17));
            }
        });
    ...
    private void addPolylineInPlayGround() {
        ...
        List<Integer> colorList = new ArrayList<Integer>();
        int[] colors = new int[]{Color.argb(255, 0, 255, 0), Color.argb(255, 255, 255, 0),
    ...
    private final double[] coords = {116.3499049793749, 39.97617053371078,
