...
public class BusLineOverlay {
    private final BusLineItem mBusLineItem;
    private final AMap mAMap;
    private final ArrayList<Marker> mBusStationMarks = new ArrayList<Marker>();
    private Polyline mBusLinePolyline;
    private final List<BusStationItem> mBusStations;
     ...
     * @param amap        地图对象。
     * @param busLineItem 公交线路。详见搜索服务模块的公交线路和公交站点包（com.amap.api.services.busline）中的类 <strong>
     *                    <a href="../../../../../../Search/com/amap/api/services/busline/BusStationItem.html" title="com.amap.api.services.busline中的类">BusStationItem</a>
     * </strong>。
     * @since V2.1.0
     */
     ...
     *
     * @param index 第几个公交站点。
     * @return 公交站点的信息。详见搜索服务模块的公交线路和公交站点包（com.amap.api.services.busline）中的类 <strong>
     *     <a href="../../../../../../Search/com/amap/api/services/busline/BusStationItem.html" title="com.amap.api.services.busline中的类">BusStationItem</a>
     * </strong>。
     * @since V2.1.0
     */
