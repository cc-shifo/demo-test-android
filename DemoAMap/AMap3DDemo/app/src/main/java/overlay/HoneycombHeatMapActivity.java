...
public class HoneycombHeatMapActivity extends Activity {
    ...
    private void testHeatMapOverlay() {
        ...
        String heatMapStr = new String(readFileContentsFromAssets(this, "heatmap/heatmap_honey" +
                ".data"));
        ...
        for (String str : heatMapStrs) {
            ...
            if (dataItem != null && dataItem.length == 3) {
                weightlatlngs[index] =
                        new WeightedLatLng(new LatLng(Double.parseDouble(dataItem[1]),
                                Double.parseDouble(dataItem[0])), Double.parseDouble(dataItem[2]));
            } else {
