...
public class MagActivity extends BaseAppCompatActivity {
    ...
    private void handleResult(Bundle bundle) {
        ...
        handler.post(() -> {
            ...
            } else showResult((TextUtils.isEmpty(presetTrack1) || presetTrack1.equals(track1))
                    && (TextUtils.isEmpty(presetTrack2) || presetTrack2.equals(track2))
                    && (TextUtils.isEmpty(presetTrack3) || presetTrack3.equals(track3)), track1, track2, track3);
            // 继续检卡
            if (!isFinishing()) {
