 ...
 * Revision History:
 * Date	                 Author	                Action
 * 20220107 	         LiuJian                  Create
 */

package com.example.demoapacheftp;
...
public final class FTPClientExample {
    ...
    public static final String USAGE =
            "Expected Parameters: [options] <hostname> <username> <password> [<remote file> " +
                    "[<local file>]]\n" +
                    "\nDefault behavior is to download a file and use ASCII transfer mode.\n" +
                    "\t-a - use local active mode (default is local passive)\n" +
                    "\t-A - anonymous login (omit username and password parameters)\n" +
                    "\t-b - use binary transfer mode\n" +
                    "\t-c cmd - issue arbitrary command (remote is used as a parameter if " +
                    "provided) \n" +
                    "\t-d - list directory details using MLSD (remote is used as the pathname if " +
                    "provided)\n" +
                    ...
                    "parsed data.\n" +
                    "\t     N.B. if the wrong server-type is used, output may be lost. Use -U or " +
                    "-S as necessary.\n" +
                    "\t-L - use lenient future dates (server dates may be up to 1 day into " +
                    "future)\n" +
                    "\t-m - list file details using MDTM (remote is used as the pathname if " +
                    "provided)\n" +
                    ...
                    "\t-t - list file details using MLST (remote is used as the pathname if " +
                    "provided)\n" +
                    ...
                    "\t-z timezone - set the time zone for displaying MDTM, LIST, MLSD, MLST " +
                    "responses\n" +
    ...
    public static void main(final String[] args) throws UnknownHostException {
        ...
        String server = "192.168.100.28";
        int port = 21;
        String remote = "ladybug_20220106_102132_2085.png";
        String local = "/";
        listFiles = true;
        ...
        try {
            ...
            /*else */
            if (listFiles || mlsd || mdtm || mlst || listNames || size) {
                if (mlsd) {
