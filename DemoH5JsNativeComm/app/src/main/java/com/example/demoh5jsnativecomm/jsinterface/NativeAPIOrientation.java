...
public class NativeAPIOrientation {
    private static final String TAG = "NativeAPIOrientation";
    private static final String API_NAME = "NativeAPIOrientation";
    ...
    private static NativeAPIOrientation mNativeAPILocation;
    private Context mContext;
    private boolean mIsGetting;
    private String mLocationCache;

    public static synchronized NativeAPIOrientation getInstance() {
        if (mNativeAPILocation == null) {
            mNativeAPILocation = new NativeAPIOrientation();
        }

        return mNativeAPILocation;
    }

    private NativeAPIOrientation() {
        // nothing
    }
    ...
    public void registerAllJsAPI(@NonNull WebView webView) {
        webView.addJavascriptInterface(this, NativeAPIOrientation.API_NAME);
    }
    ...
    public String getHeading() {
        synchronized (NativeAPIOrientation.this) {
            if (mIsGetting) {
