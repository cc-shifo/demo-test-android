...
public class AppInfoStorageCacheBak {
    private static final String PACKAGE_CACHE_FILE_NAME = "packages.json";
    private File mCache;

    public static AppInfoStorageCacheBak getInstance() {
...
//        String path = HelloWorldApp.getApplication().getFilesDir().getAbsolutePath();
    ...
    private static class Singleton {
        private static AppInfoStorageCacheBak instance = new AppInfoStorageCacheBak();
        private Singleton() {
            //do nothing
        }
    }
